...
export function CommunityPromise({ cms }: { cms?: any }) {
  return (
    <section
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <div className="relative w-full aspect-[3/4] rounded-2xl overflow-hidden">
              <Image
                src="/donate/IMG-20260513-WA0108.jpg"
                alt="Surraya school community"
                fill
            ...
            {TESTIMONIALS.map((t) => (
              ...
              >
                <Quote size={22} style={{ color: "var(--color-gold)" }} fill="currentColor" aria-hidden="true" />
                <p className="mt-2 text-sm leading-relaxed italic" style={{ color: "var(--color-slate)" }}>
                  &ldquo;{t.quote}&rdquo;
                </p>
          ...
          >
            <p className="mb-3 text-xs font-bold uppercase tracking-widest" style={{ color: "var(--color-forest-mid)" }}>
              Our Promise to You
            </p>
            <h2 className="font-serif text-4xl lg:text-5xl leading-tight" style={{ color: "var(--color-forest-deep)" }}>
              Every Penny
              <span className="block italic" style={{ color: "var(--color-forest)" }}>
                Accounted For
              </span>
            </h2>
            <p className="mt-5 text-base leading-relaxed" style={{ color: "var(--color-slate)" }}>
