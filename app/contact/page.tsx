...
const description = `Reach out to Surraya Islamic Nursery School. Visit us at ${SITE.address}, call ${SITE.phone}, or send a message online. We respond within 1–2 business days.`;
